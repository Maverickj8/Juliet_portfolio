...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn("h-full relative bg-white w-full", containerClassName)}>
      ...
      {showGradient && (
        <div className="absolute inset-0 bg-linear-to-t from-gray-950/90 to-transparent" />
      )}
    </div>
  );
};
    ...
    return new THREE.ShaderMaterial({
      vertexShader: `
        ...
        void main(){
          ...
          fragCoord = (position.xy + vec2(1.0)) * 0.5 * vec2(${size.width * 2.0}, ${size.height * 2.0});
        }
      `,
